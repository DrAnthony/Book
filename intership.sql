...
/*!40000 ALTER TABLE `book`
    DISABLE KEYS */;
INSERT INTO `book`
VALUES (1, 3, '三体', '刘慈欣', 32, '1999-02-01', 10, 7, 0.00, 1, NULL, 1),
       (3, 3, '美国众神：十周年作者修订版', '尼尔·盖曼', 34, '2017-05-01', 100, 100, 69.90, 1, '9787550297142', 0),
       (4, 34, '大学国际化的历程', '程星', 11, '2014-09-01', 100, 100, 40.20, 1, '9787100106252', 0),
       (5, 8, '居里夫人传', '艾芙·居里', 11, '1984-07-01', 20, 20, 28.40, 1, '9787100001076', 0),
       (6, 8, '爱因斯传', '亚伯拉罕·派斯', 11, '2004-09-01', 20, 20, 69.00, 1, '9787100038829', 0),
       (7, 10, '逻辑思维训练500题', '于雷', 15, '2013-01-01', 20, 20, 39.00, 1, '9787302303619', 0),
       (8, 27, 'C语言零基础入门学习：带你学C带你飞', '小甲鱼', 15, '2019-05-01', 20, 20, 79.00, 0, '9787302505945', 0),
       (9, 10, '中国哲学简史', '冯友兰', 20, '2013-01-01', 20, 20, 38.00, 0, '9787301215692', 0),
       (10, 15, '博弈论与经济行为', '冯·诺伊曼,摩根斯坦', 20, '2018-04-01', 20, 20, 158.00, 0, '9787301293263', 0),
...
/*!40000 ALTER TABLE `captcha`
    DISABLE KEYS */;
INSERT INTO `captcha`
VALUES (2, 2, 'x81Xag8dj9ZpFgR22md3zw==', '2019-07-23');
/*!40000 ALTER TABLE `captcha`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
    ...
    PRIMARY KEY (`id`),
    KEY `u_fk` (`s_id`),
    CONSTRAINT `u_fk` FOREIGN KEY (`s_id`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE = InnoDB
  AUTO_INCREMENT = 5
  DEFAULT CHARSET = utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
VALUES (3, NULL, 'This is a test comment'),
       (4, NULL, 'This is a test comment');
/*!40000 ALTER TABLE `comments`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
    ...
    KEY `s_fk` (`s_id`),
    KEY `b_fk` (`b_id`),
    CONSTRAINT `b_fk` FOREIGN KEY (`b_id`) REFERENCES `book` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
    CONSTRAINT `s_fk` FOREIGN KEY (`s_id`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE = InnoDB
  AUTO_INCREMENT = 7
  DEFAULT CHARSET = latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `stubook`
    DISABLE KEYS */;
INSERT INTO `stubook`
VALUES (1, NULL, 1, '2019-07-14', '2019-09-14', 0, 1),
       (2, NULL, 1, '2019-07-14', '2019-07-24', 0, 1),
       (3, NULL, 1, '2019-07-17', '2019-09-17', 0, 0),
       (4, 2, 1, '2019-07-19', '2019-09-19', 0, 0),
       (5, 2, 1, '2019-07-19', '2019-09-19', 0, 0),
       (6, 2, 1, '2019-07-19', '2019-09-19', 0, 0);
/*!40000 ALTER TABLE `stubook`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 'tom', 1, '4QrcOUm6Wau+VuBX8g+IPg==', '15863755633', 1, 10, 10, '2019-07-14 11:50:21', NULL, 'tom', NULL,
        NULL),
       (2, 'root', 0, '4QrcOUm6Wau+VuBX8g+IPg==', '13612345678', 1, 10, 7, '2019-07-23 13:23:08', '1563530021608.jpg',
        'testAdmin', 'for test', '1949-10-01'),
       (5, NULL, 1, '123456', '13611111111', 2, 10, 10, '2019-07-22 09:35:53', NULL, NULL, NULL, NULL);
/*!40000 ALTER TABLE `user`
    ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-07-23 14:12:30
