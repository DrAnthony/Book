...
--
-- Dumping events for database 'intership'
--
/*!50106 SET @save_time_zone = @@TIME_ZONE */;
/*!50106 DROP EVENT IF EXISTS `update_time` */;
DELIMITER ;;
...
/*!50106 CREATE */ /*!50117 DEFINER =`root`@`localhost`*/ /*!50106 EVENT `update_time` ON SCHEDULE EVERY 1 DAY STARTS '2019-08-03 00:00:00' ON COMPLETION PRESERVE ENABLE DO call updatetime */ ;;
...
--
-- Dumping routines for database 'intership'
--
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `updatetime`()
begin
    declare var_now date default curdate();
    declare var_id int default null;
    declare var_days int default null;
    declare var_date date default null;
    declare done boolean default 0;
    declare cur cursor for
        select id, r_date from stubook where r_date <= var_now and isreturned = 0;
    declare continue handler for sqlstate '02000' set done = 1;
    open cur;
    repeat
        fetch cur into var_id,var_date;
        set var_days = datediff(var_now, var_date);
        update stubook set overtime=var_days where id = var_id;
    until done
        end repeat;
    close cur;
end ;;
...
-- Dump completed on 2019-08-02  7:57:39
